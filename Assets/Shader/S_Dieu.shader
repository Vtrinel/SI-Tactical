...
Shader "S_Dieu"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_128_0 = ( 1.0 - step( ( pow( tex2D( _T_Triangle2_M, panner83 ).r , _MaskPower ) * smoothstepResult78 ) , ase_vertex3Pos.y ) );
...
/*ASEBEGIN
Version=15900
-1920;40;1907;980;1247.21;1273.04;2.185627;True;True
...
ASEEND*/
//CHKSM=663364221758CCAB4A6700938C2476B98757B81E