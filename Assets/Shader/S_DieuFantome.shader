...
Shader "S_DieuIFantome"
{
	Properties
	{
		...
		_DisplacmentStrengh("DisplacmentStrengh", Range( 0 , 5)) = 0
	...
	SubShader
	{
		...
		uniform float _DisplacmentStrengh;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_cast_1 = (pow( tex2Dlod( _DisplacmentMap, float4( panner153, 0, 0.0) ).b , _DisplacmentStrengh )).xxx;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float lerpResult138 = lerp( ( step( ( smoothstepResult78 * pow( tex2D( _T_Triangle_M, panner83 ).r , _MaskPower ) ) , ase_vertex3Pos.y ) * pow( tex2DNode46.r , 0.5 ) ) , 0.0 , _Opacity);
...
/*ASEBEGIN
Version=15900
-1910;36;1907;980;4401.369;1875.305;4.854483;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-368.2079,683.6812;Float;False;Property;_ShadowStep;ShadowStep;6;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;18;39.72767,204.7937;Float;False;Property;_Color;Color;1;0;Create;True;0;0;False;0;1,1,1,0;1,0.4884658,0.07843129,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;91;299.0689,-458.7914;Float;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;147.8686,740.6866;Float;False;Property;_ShadowOpacity;ShadowOpacity;7;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;153;1064.462,877.8373;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;151;1250.685,902.8806;Float;True;Property;_DisplacmentMap;DisplacmentMap;17;0;Create;True;0;0;False;0;9356c8d0cbb79e04399fb57f38b142ed;9356c8d0cbb79e04399fb57f38b142ed;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;157;1400.292,1159.9;Float;False;Property;_DisplacmentStrengh;DisplacmentStrengh;18;0;Create;True;0;0;False;0;0;1.97;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;142;1481.589,-355.5108;Float;False;Property;_Emmissive;Emmissive;16;0;Create;True;0;0;False;0;0,0,0,0;0.9528301,0.6754391,0.2202295,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PowerNode;156;1580.69,812.7896;Float;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=AE3C7F4E8F738F125F4AFF74FFA6F0C00E406D7B